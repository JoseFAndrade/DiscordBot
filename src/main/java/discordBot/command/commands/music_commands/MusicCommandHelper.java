...
public class MusicCommandHelper {
    ...
    public static void userInChannel(MessageReceivedEvent
 event) throws MusicException.UserNotInChannel {
    ...
    public static void botInChannel(MessageReceivedEvent
 event) throws MusicException.BotNotInChannel
    {
    ...
    public static AudioTrack musicToPlay(MessageReceivedEvent
 event) throws MusicException.NoCurrentSong{
