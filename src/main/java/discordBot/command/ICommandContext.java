...
public interface ICommandContext {
    ...
    /**
     * Returns the {@link net.dv8tion.jda.api.events.message.guild.MessageReceivedEvent
 message event} that was received for this instance
     *
     * @return the {@link net.dv8tion.jda.api.events.message.guild.MessageReceivedEvent
 message event} that was received for this instance
     */
