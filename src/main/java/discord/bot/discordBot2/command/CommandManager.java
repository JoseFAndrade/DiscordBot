...
import discord.bot.discordBot2.command.commands.*;
import discord.bot.discordBot2.command.commands.arknights.*;
import discord.bot.discordBot2.command.commands.music_commands.*;
