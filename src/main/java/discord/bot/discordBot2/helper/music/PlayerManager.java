package discord.bot.discordBot2.helper.music;
...
public class PlayerManager {
    ...
    public void loadAndPlay(final TextChannel channel, final String trackUrl, GuildMessageReceivedEvent event) {
    ...
    public void pause(PlayerManager pM, GuildMessageReceivedEvent event){
    ...
    public void resume(PlayerManager pM, GuildMessageReceivedEvent event){
        MessageChannel channel = event.getChannel();
        GuildMusicManager musicManager = pM.getGuildAudioPlayer(event.getGuild());
        musicManager.scheduler.unpause();
        //channel.sendMessage("Player now resumed.").queue();
    }

    public void skipTrack(PlayerManager pM, GuildMessageReceivedEvent event) {
        MessageChannel channel = event.getChannel();
        GuildMusicManager musicManager = pM.getGuildAudioPlayer(event.getGuild());
    ...
    public void changeVolume(PlayerManager pM, int volume, GuildMessageReceivedEvent event ){
        MessageChannel channel = event.getChannel();
    ...
    public void clear(PlayerManager pM, GuildMessageReceivedEvent event){
        MessageChannel channel = event.getChannel();
        GuildMusicManager musicManager = pM.getGuildAudioPlayer(event.getGuild());
    ...
    public ArrayList<AudioTrack> getTracks(PlayerManager pM, GuildMessageReceivedEvent event){
        MessageChannel channel = event.getChannel();
        GuildMusicManager musicManager = pM.getGuildAudioPlayer(event.getGuild());
    ...
    public AudioTrack currentSong (PlayerManager pM, GuildMessageReceivedEvent event){
        GuildMusicManager musicManager = pM.getGuildAudioPlayer(event.getGuild());
        return musicManager.player.getPlayingTrack();
    }

    public void shuffleSongs(PlayerManager pM, GuildMessageReceivedEvent event){
        GuildMusicManager musicManager = pM.getGuildAudioPlayer(event.getGuild());
